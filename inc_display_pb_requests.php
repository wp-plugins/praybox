...
//VIEW DETAILS OUTPUT
	...
	$view_details_output.="<div class='back'><a href='$url_novars'><< Back to Request List</a><div style='clear:both;'></div></div>";
	...
	$view_details_output.="<form class='flag' method='post' action='$url_novars'><input type='hidden' name='action' value='flag_this_request' /><input type='hidden' name='pb_request_id' value='$req_id' /><input type='submit' value='Report Abuse' /></form>";
	...
	$view_details_output.="<form method='post' action='$url_novars'><input type='hidden' name='action' value='prayed_for' /><input type='hidden' name='pb_request_id' value='$req_id' /><input type='submit' value='I Prayed For You' /></form>";
	$view_details_output.="</td></tr>";
